...
class HiperBootRepositoryColumnsTest extends BaseTestClass {
    ...
    void caseInsensitiveEqualsFilterStringColumnTest() {
        List<ParentTable> results = level01Repository.hiperBootFilter(ParentTable.class, columnEqualValues("colString", "abc"));
    ...
    void randomEqualsFilterAllColumnsTest() {
        ...
        for (Map.Entry<String, Field> entry : fieldMaps.entrySet()) {
            ...
            results = level01Repository.hiperBootFilter(ParentTable.class, columnEqualValues(columnName, val.toString()));
            assertThat(results).isNotEmpty();
    ...
    void randomNotEqualsFilterAllColumnsTest() {
        ...
        for (Map.Entry<String, Field> entry : fieldMaps.entrySet()) {
            ...
            var val = getFieldValue(randomRow, field);
            results = level01Repository.hiperBootFilter(ParentTable.class, columnNotEqualValues(columnName, val.toString()));
            assertThat(results).isNotEmpty();
    ...
    void randomInCaseInsensitiveFilterStringTest() {
        List<ParentTable> results = level01Repository.hiperBootFilter(ParentTable.class, columnEqualValues("colString", "abc", "xxx"));
        assertThat(results).hasSize(2);
    }
    ...
    void randomNotInFilterAllColumnsTest() {
        ...
        for (Map.Entry<String, Field> entry : fieldMaps.entrySet()) {
            ...
            results = level01Repository.hiperBootFilter(ParentTable.class, columnNotEqualValues(columnName, val1, val2));
    ...
    void randomGreaterThanFilterAllColumnsTest() {
        ...
        for (Map.Entry<String, Field> entry : fieldMaps.entrySet()) {
            ...
            results = level01Repository.hiperBootFilter(ParentTable.class, columnGreaterThan(columnName, valFrom.toString()));
    ...
    void randomSmallerThanFilterAllColumnsTest() {
        ...
        for (Map.Entry<String, Field> entry : fieldMaps.entrySet()) {
            ...
            Field field = entry.getValue();
            var valFrom = getFieldValue(randomRow, field);
            results = level01Repository.hiperBootFilter(ParentTable.class, columnSmallerThan(columnName, valFrom.toString()));
    ...
    void randomLikeFilterAllColumnsTest() {
        List<ParentTable> results = level01Repository.hiperBootFilter(ParentTable.class, columnEqualValues("colString", "%Ab%"));
        assertThat(results).hasSize(2);
    }
    ...
    void randomNullFilterAllColumnsTest() {
        ...
        for (Map.Entry<String, Field> entry : fieldMaps.entrySet()) {
            ...
            List<ParentTable> results = level01Repository.hiperBootFilter(ParentTable.class, columnIsNull(columnName));
    ...
    @Test
    void manyToOneTest() {
        List<ParentTable> results = level01Repository.hiperBootFilter(ParentTable.class, columnSubEntity("someTable.name", "NAme c"));
        assertThat(results).hasSize(1);
    ...
    @Test
    void oneToManyTest() {
        List<ParentTable> results = level01Repository.hiperBootFilter(ParentTable.class, columnSubEntity("children.number", "30"));
        assertThat(results).hasSize(1);
